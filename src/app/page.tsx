...
export default async function Home() {
  const res = await fetch(
    "https://my-portfolio-backend-jc7r.onrender.com/api/v1/get/user/65b3a22c01d900e96c4219ae"
  );
  // const res = await fetch(
  //   "http://localhost:3000/api/v1/get/user/65b3a22c01d900e96c4219ae"
  // );
  ...
  return (
    <main className="relative">
      <Transition className="fixed md:top-8 top-6 md:left-8 left-6 z-30 hover:text-white/80 text-white/40">
        <Link href={"/"}>
          <TextReveal className="font-semibold ">Pranay Bhatnagar.</TextReveal>
        </Link>
      </Transition>
      ...
      <section className="py-20 relative" id="testimonials">
        ...
        <SectionHeading className="md:pl-28">
          ...
          <SlideIn className="">Mentors & Clients Say</SlideIn>
        </SectionHeading>
